...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--batch", dest="batch_file", help="a file containing a list of workspace paths"
    )
    parser.add_argument(
        "--log", dest="log_file", help="a file to save the judge result"
    )
    parser.add_argument("--input_dir", help="where test cases comes from")
    parser.add_argument(
        "--citation_dir", help="where citation for test cases comes from"
    )
